...
RSpec.describe BloggersController, type: :controller do
  ...
  # BloggersController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all bloggers as @bloggers" do
      blogger = Blogger.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:bloggers)).to eq([blogger])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested blogger as @blogger" do
      blogger = Blogger.create! valid_attributes
      get :show, {:id => blogger.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested blogger as @blogger" do
      blogger = Blogger.create! valid_attributes
      get :edit, {:id => blogger.to_param}, valid_session
      expect(assigns(:blogger)).to eq(blogger)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Blogger" do
        expect {
          post :create, {:blogger => valid_attributes}, valid_session
      ...
      it "redirects to the created blogger" do
        post :create, {:blogger => valid_attributes}, valid_session
        expect(response).to redirect_to(Blogger.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved blogger as @blogger" do
        post :create, {:blogger => invalid_attributes}, valid_session
        expect(assigns(:blogger)).to be_a_new(Blogger)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested blogger" do
        blogger = Blogger.create! valid_attributes
        put :update, {:id => blogger.to_param, :blogger => new_attributes}, valid_session
        blogger.reload
      ...
      it "assigns the requested blogger as @blogger" do
        blogger = Blogger.create! valid_attributes
        put :update, {:id => blogger.to_param, :blogger => valid_attributes}, valid_session
        expect(assigns(:blogger)).to eq(blogger)
      end
      ...
      it "redirects to the blogger" do
        blogger = Blogger.create! valid_attributes
        put :update, {:id => blogger.to_param, :blogger => valid_attributes}, valid_session
        expect(response).to redirect_to(blogger)
      end
    end

    context "with invalid params" do
      it "assigns the blogger as @blogger" do
        blogger = Blogger.create! valid_attributes
        put :update, {:id => blogger.to_param, :blogger => invalid_attributes}, valid_session
        expect(assigns(:blogger)).to eq(blogger)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested blogger" do
      blogger = Blogger.create! valid_attributes
      expect {
        delete :destroy, {:id => blogger.to_param}, valid_session
      }.to change(Blogger, :count).by(-1)
    end
