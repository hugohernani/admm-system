  ...
  describe 'POST #create' do
    context 'when success' do
      it 'create a new blogger' do
        expect do
          post :create, blogger: valid_attributes
    ...
    context 'when fail' do
      it 'assigns a newly created but unsaved blogger as @blogger' do
        post :create, blogger: invalid_attributes
  ...
  describe 'PUT #update' do
    context 'when success' do
      ...
      it 'updates the requested blogger' do
        ...
        put :update, id: blogger.to_param, blogger: new_attributes
        blogger.reload
      ...
      it 'assigns the requested blogger as @blogger' do
        ...
        put :update, id: blogger.to_param, blogger: valid_attributes
    ...
    context 'when fail' do
      ...
      it 'do not change information' do
        put :update, id: blogger.id, blogger: { theme: nil }
